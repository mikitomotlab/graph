...
def plot_values5(d, q, dist, n, def_ang, f_dir, fname, dd, qid, dd2, dd3):
	Pbst = n.argmin()#normの最小値
	A = d[:,6]
	B = d[:,7]
	Bc= d[:,8]
	...
	fig = plt.figure(figsize=(25,20))	#figsize=（横幅、縦幅）
	#queryimgのピクセル数
	...
	#類似度グラフ
	ax11 = fig.add_subplot(5,1,2)#グラフを描画する場所を定義
	si=(Bc+C)/(A+B+C+D+E+0.0001) #類似度の評価方法を定義
	p=si.argmax()
	...
	#存在確率分布を作成
	maxd = dd.argmax()
	sonzai = fig.add_subplot(5,1,3)#グラフを描画する場所を定義
	#sonzai.plot(dd[0], linestyle='solid',lw=0.1,  color ='blue', label="normal distribution")#plt.legend(loc="lower right")
	#sonzai.plot(dd[1], linestyle='solid',lw=0.1,  color ='grey', label="normal distribution")#plt.legend(loc="lower right")
	#sonzai.plot(dd, linestyle='solid',lw=0.1,  color ='red', label="query_pixel")
	sonzai.plot([Pbst,Pbst], [dd[1], dd[1]], linestyle='solid',lw=0.1,  color ='blue', label="normal distribution")#plt.legend(loc="lower right")
	sonzai.plot([Pbst,Pbst], [dd[2], dd[2]], linestyle='solid',lw=0.1,  color ='red', label="normal distribution")#plt.legend(loc="lower right")
	#sonzai.text(0,0.15, str(maxd),size=10,color="blue") #推定位置座標
	#sonzai.plot(dd, 'o', markersize=8, markeredgewidth=0.2, color='none', markeredgecolor='blue', alpha=0.3)
	sonzai.plot(dd, linestyle='solid',lw=0.1,  color ='grey', label="query_pixel")
	...
	#存在確率分布を作成
	maxd2 = dd2.argmax()
	sonzai2 = fig.add_subplot(5,1,4)#グラフを描画する場所を定義
	sonzai2.set_title("normal distribution" ,size=12,color="black")
	#sonzai2.title('normal distribution')
	sonzai2.xlabel('DB imageID')
	sonzai2.ylabel('noramal distribution and UMap')
#	sonzai.plot([Pbst,Pbst], [dd[0], dd[0]], linestyle='solid',lw=0.1,  color ='grey', label="normal distribution")#plt.legend(loc="lower right")
#	sonzai.plot([Pbst,Pbst], [dd[1], dd[1]], linestyle='solid',lw=0.1,  color ='blue', label="normal distribution")#plt.legend(loc="lower right")
#	sonzai.plot([Pbst,Pbst], [dd[2], dd[2]], linestyle='solid',lw=0.1,  color ='red', label="normal distribution")#plt.legend(loc="lower right")
	sonzai2.text(0,0.15, str(maxd),size=10,color="blue") #推定位置座標
	#sonzai.plot(dd, 'o', markersize=8, markeredgewidth=0.2, color='none', markeredgecolor='blue', alpha=0.3)
	sonzai2.plot(dd, linestyle='solid',lw=0.1,  color ='grey', label="normal distribution")
	sonzai2.plot(dd2, linestyle='solid',lw=0.1,  color ='red')
	sonzai2.plot(dd3, linestyle='solid',lw=0.1,  color ='blue')

	#存在確率分布を作成
	maxd = dd.argmax()
	sonzai3 = fig.add_subplot(5,1,5)#グラフを描画する場所を定義
	sonzai3.title('reliability')
	sonzai3.xlabel('DB imageID')
	sonzai3.ylabel('UMap realibility')
#	sonzai.plot([Pbst,Pbst], [dd[0], dd[0]], linestyle='solid',lw=0.1,  color ='grey', label="normal distribution")#plt.legend(loc="lower right")
#	sonzai.plot([Pbst,Pbst], [dd[1], dd[1]], linestyle='solid',lw=0.1,  color ='blue', label="normal distribution")#plt.legend(loc="lower right")
#	sonzai.plot([Pbst,Pbst], [dd[2], dd[2]], linestyle='solid',lw=0.1,  color ='red', label="normal distribution")#plt.legend(loc="lower right")
...
def plot_values6(d, q, dist, n, def_ang, f_dir, fname, dd, qid, dd2, dd3):
	Pbst = n.argmin()#normの最小値
	A = d[:,6]
	B = d[:,7]
	Bc= d[:,8]
	...
	si=(Bc+C)/(A+B+C+D+E+0.0001) #類似度の評価方法を定義
	p=si.argmax()
	plt.plot(si, linestyle='solid',lw=0.1,  color ='grey', label="simirality")
	plt.legend(loc="lower right")
	#plt.ylim(0,0.2)
	plt.plot([Pbst,Pbst],[0,0.2], linestyle='solid',lw=0.3, color ='red')#真値座標を定義
	plt.plot(p,si[p], 'o', markersize=8, markeredgewidth=0.2, color='none', markeredgecolor='blue', alpha=0.3)
...
#	sonzai.plot(dd[0], linestyle='solid',lw=0.1,  color ='blue', label="normal distribution")#plt.legend(loc="lower right")
#	sonzai.plot(dd[1], linestyle='solid',lw=0.1,  color ='grey', label="normal distribution")#plt.legend(loc="lower right")
	plt.plot(dd, linestyle='solid',lw=0.1,  color ='lightskyblue', label="query_pixel")
	plt.plot(si, linestyle='solid',lw=0.1,  color ='grey', label="simirality")
	plt.plot(maxd, dd[maxd], 'o', markersize=8, markeredgewidth=0.2, color='none', markeredgecolor='blue', alpha=0.3)
#	sonzai.plot([Pbst,Pbst], [dd[1], dd[1]], linestyle='solid',lw=0.1,  color ='blue', label="normal distribution")#plt.legend(loc="lower right")
#	sonzai.plot([Pbst,Pbst], [dd[2], dd[2]], linestyle='solid',lw=0.1,  color ='red', label="normal distribution")#plt.legend(loc="lower right")
...
#	sonzai.plot([Pbst,Pbst], [dd[2], dd[2]], linestyle='solid',lw=0.1,  color ='red', label="normal distribution")#plt.legend(loc="lower right")
	...
	#sonzai.plot(dd, 'o', markersize=8, markeredgewidth=0.2, color='none', markeredgecolor='blue', alpha=0.3)
#	plt.plot(dd, linestyle='solid',lw=0.1,  color ='grey', label="normal distribution")
	plt.plot(dd2, linestyle='solid',lw=0.1,  color ='red')
#	plt.plot(si, linestyle='solid',lw=0.1,  color ='grey', label="simirality")
#	plt.plot(dd3, linestyle='solid',lw=0.1,  color ='blue')
	plt.plot(maxd2, dd2[maxd2], 'o', markersize=8, markeredgewidth=0.2, color='none', markeredgecolor='blue', alpha=0.3)
	plt.plot([Pbst,Pbst],[0,1.0], linestyle='solid',lw=0.7, color ='blue')#真値座標を定義
...
#	siwithno = np.hstack([np.vstack(n), np.vstack(si)])
#	siwithnon = sorted(siwithno[:,0])

	dsi = dict(zip(norm,si))
...
#	sonzai.plot(dd[0], linestyle='solid',lw=0.1,  color ='blue', label="normal distribution")#plt.legend(loc="lower right")
#	sonzai.plot(dd[1], linestyle='solid',lw=0.1,  color ='grey', label="normal distribution")#plt.legend(loc="lower right")
	#plt.plot(n, linestyle='solid',lw=0.1,  color ='lightskyblue', label="query_pixel")
	#print("nn: {}".format(nn))
	#time.sleep(3)
