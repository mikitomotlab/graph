...
def plot_values5(d, q, dist, n, def_ang, f_dir, fname, dd, qid):
	...
	sonzai.plot(dd, linestyle='solid',lw=0.1,  color ='grey', label="Existance probably distribution")#plt.legend(loc="lower right")
	...
	sonzai.text(0,0.0, "d:"+str(round(dist[p],4))+", n:"+str(round(n[p],3)),size=12,color="blue")
